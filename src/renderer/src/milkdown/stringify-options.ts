...
// Originally established as a spike artifact in tests/spike/milkdown-fixture.ts
// (Phase 1 feasibility spike) — this file is now the source of truth;
// tests/spike's copy is historical and should not be imported from production
// code.
