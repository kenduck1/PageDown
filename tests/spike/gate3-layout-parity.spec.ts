...
import { launchIsolatedApp } from '../gates/electron-launch'
...
// every other Phase 0/1 gate spec (see tests/gates/gate1/gate5/gate7's own
...
// tests/gates/gate10-editor-layout-parity.spec.ts measures the REAL app's parity
...
// `getComputedStyle()` values from a real render of tests/gates/corpus/mixed.md
...
// rather than chosen. tests/spike/fixtures/milkdown-compare.html replicates
...
//   + `__pagedownPhase0` bridge, exactly like tests/gates/gate6-break-
//   quality.spec.ts and tests/gates/gate9's probe. This is the side where
...
//   tests/spike/fixtures/milkdown-compare.html as a local `file://` page. This
...
// -- confirmed by running it against tests/gates/corpus/mixed.md directly, its
